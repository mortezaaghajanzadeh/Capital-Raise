		...
		\begin{columns}
			...
			\begin{table}
				...
				\resizebox{1\textwidth}{!}{
					\input{Output/QuantileIndNT_Im.tex}
				}
			
				\resizebox{1\textwidth}{!}{
				\input{Output/QuantileIndNT_Hm.tex}
			}
			\end{table}
		\hfill
			\column{0.48\textwidth}
			\begin{table}
				\centering
				\resizebox{1\textwidth}{!}{
					\input{Output/QuantileInsNT_Im.tex}
				}
			
			\resizebox{1\textwidth}{!}{
				\input{Output/QuantileInsNT_Hm.tex}
			}
			\end{table}
		\end{columns}
	\end{frame}
...
\begin{frame}
	\begin{columns}
		...
		\begin{table}
			\centering
			\resizebox{1\textwidth}{!}{
				\input{Output/QuantileExcess.tex}
			}
		\end{table}
	\end{columns}			
\end{frame}	
